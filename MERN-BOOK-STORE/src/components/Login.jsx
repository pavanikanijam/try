...
import googleLogo from "../assets/banner-books/R (1).png"
  ...
  return (
	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            {error ?  <p className='text-red-600 text-base'>Email or Password is not currect:</p> : ""}
                        <p>If your haven't an account.please<Link to="/sign-up" className='text-blue-600 underline'>Signup</Link>Here</p>
						<div className="relative">
