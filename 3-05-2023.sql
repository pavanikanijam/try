2SELECT * FROM MANAGER1;
-- FINDING THE 2ND LARGEST SALARY FROM MANAGER1 TABLE
SELECT NAME, SALARY FROM MANAGER2 ORDER BY SALARY DESC LIMIT 1,1;

-- FINDING THE 3RD LARGEST SALARY FROM MANAGER1 TABLE
SELECT NAME,SALARY FROM MANAGER2 ORDER BY SALARY DESC LIMIT 2,1;

-- FINDING THE 4TH LARGEST SALARY FROM MANAGER1 TABLE
SELECT NAME,SALARY FROM MANAGER2 ORDER BY SALARY DESC LIMIT 3,1;

-- FINDING THE 1ST LARGEST SALARY FROM MANAGER1 TABLE
SELECT NAME,SALARY FROM MANAGER2 ORDER BY SALARY DESC LIMIT 0,1;
...
INSERT INTO CUSTOMER1 VALUES(200,'pavanii','SUBBAREDDY','INDIA'),(201,'sunil','naveen','US'),(204,'Ravi','SURYA','UK')
,(205,'YAMUNA','Lakshi','RUSSIA'),(209,'SUMANTH','VANI','INDIA');
SELECT* FROM ORDERS1;
...
SELECT * FROM ORDERS1;
UPDATE ORDERS1 SET SHIPPING_ID =1324 WHERE ORDER_ID = 210;
UPDATE ORDERS1 SET SHIPPING_ID =8128 WHERE ORDER_ID = 211;
UPDATE ORDERS1 SET SHIPPING_ID =9219 WHERE ORDER_ID = 212;
UPDATE ORDERS1 SET SHIPPING_ID =7427 WHERE ORDER_ID = 214;
UPDATE ORDERS1 SET SHIPPING_ID =6146 WHERE ORDER_ID = 213;

CREATE TABLE SHIPPING(
SHIPPING_ID INT,NAME VARCHAR(37));
INSERT INTO SHIPPING VALUES(2344,'ABC'),(8234,'XYZ'),(2347,'YYY'),(6432,'YZZ'),(8238,'SXS');
SELECT * FROM ORDERS1;
SELECT * FROM CUSTOMER1;
